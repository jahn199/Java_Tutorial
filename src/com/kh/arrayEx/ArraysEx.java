...
deepEquals(2차원이상의 배열 비교1번수명, 2차원이상의 배열 비교2번수명)      2차원 이상의 두 배열이 동일한지 비교
 */
public class ArraysEx {
        public void arr1DMethod(){
            ...
            System.out.println(Arrays.toString(arr1));//오름차순으로 arr1이 제대로 정렬 됐는지 확인
            ...
            //arr1의 값을 모두 7로 변경했기 때문에 arr2 비교했을 때 false가 나옴
        }
