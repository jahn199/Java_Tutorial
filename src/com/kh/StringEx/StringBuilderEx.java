...
public class StringBuilderEx {
    ...
    delete(int start, int end) = 지정된 법위의 문자열 삭제
    ...
    public void methodStringBuilder(){
        ...
        //insert를 이용해서 6번째 위치에 [ Java ] 글자 삽입
        //index 0부터 시작
        sb2.insert(5," Java ");
        System.out.println("Java 추가 확인 : " + sb2);

        //replace를 이용해서 6-10 범위를 Python으로 대체
        sb2.replace(6,10, "Python");
        System.out.println("Java->Python : " + sb2);

        //6~13범위의 값 삭제
        sb2.delete(6,13);
        System.out.println("6~13번째 삭제  : " + sb2);

        //reverse를 이용해서 sb2 문자열 뒤집기
        sb2.reverse();
        System.out.println("sb2 문자열 뒤집기 : " + sb2);
    }
